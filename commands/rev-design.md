...
# 特定の設計書のみ生成
gemini rev-design --target architecture
gemini rev-design --target api
gemini rev-design --target database

# 特定のディレクトリを分析
gemini rev-design --path ./backend

# 出力形式指定
gemini rev-design --format markdown,openapi
```
